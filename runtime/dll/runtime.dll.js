...
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){_defineProperty(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}var shared_initialState={};/* harmony default export */ const shared = (function(){var state=arguments.length>0&&arguments[0]!==void 0?arguments[0]:shared_initialState;var action=arguments.length>1?arguments[1]:void 0;switch(action.type){case platformfrom_dll_reference_platform_dll.constants.ADD_SHARED:{var nextState=_objectSpread({},state);nextState[action.payload.name]=action.payload.data;return nextState;}case platformfrom_dll_reference_platform_dll.constants.REMOVE_SHARED:{var _nextState=_objectSpread({},state);delete _nextState[action.payload.name];return _nextState;}default:{return state;}}});
