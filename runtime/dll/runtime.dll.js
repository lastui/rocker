...
/*!*******************************************************************!*\
  !*** ./node_modules/@lastui/rocker/runtime/index.js + 10 modules ***!
  \*******************************************************************/
...
// EXTERNAL MODULE: delegated ./node_modules/react-router-dom/index.js from dll-reference dependencies_dll
var react_router_domfrom_dll_reference_dependencies_dll = __webpack_require__("./node_modules/react-router-dom/index.js");
...
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){_defineProperty(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}function _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true});}else{obj[key]=value;}return obj;}var refCount={};var initialState={language:"en-US",messages:{},entrypoint:null,ready:false};/* harmony default export */ const runtime = (function(){var state=arguments.length>0&&arguments[0]!==void 0?arguments[0]:initialState;var action=arguments.length>1?arguments[1]:void 0;switch(action.type){case platformfrom_dll_reference_platform_dll.constants.SET_LANGUAGE:{return{language:action.payload.language,entrypoint:state.entrypoint,ready:state.ready,messages:state.messages};}case platformfrom_dll_reference_platform_dll.constants.ADD_I18N_MESSAGES:{var nextMessages=_objectSpread({},state.messages);for(var locale in action.payload.data){if(!nextMessages[locale]){nextMessages[locale]={};}for(var id in action.payload.data[locale]){if(refCount[id]){refCount[id]++;}else{refCount[id]=1;}nextMessages[locale][id]=action.payload.data[locale][id];}}return{language:state.language,entrypoint:state.entrypoint,ready:state.ready,messages:nextMessages};}case platformfrom_dll_reference_platform_dll.constants.REMOVE_I18N_MESSAGES:{var _nextMessages=_objectSpread({},state.messages);for(var _locale in action.payload.data){for(var _id in action.payload.data[_locale]){if(refCount[_id]){refCount[_id]--;}}}var toDelete=[];for(var _id2 in refCount){if(refCount[_id2]){continue;}for(var _locale2 in state.messages){delete _nextMessages[_locale2][_id2];}toDelete.push(_id2);}for(var _i=0,_toDelete=toDelete;_i<_toDelete.length;_i++){var _id3=_toDelete[_i];delete refCount[_id3];}return{language:state.language,entrypoint:state.entrypoint,ready:state.ready,messages:_nextMessages};}case platformfrom_dll_reference_platform_dll.constants.MODULES_READY:{return{language:state.language,entrypoint:state.entrypoint,ready:action.payload.isReady,messages:state.messages};}case platformfrom_dll_reference_platform_dll.constants.SET_ENTRYPOINT_MODULE:{return{language:state.language,entrypoint:action.payload.entrypoint,ready:state.ready,messages:state.messages};}default:{return state;}}});
;// CONCATENATED MODULE: ./node_modules/@lastui/rocker/runtime/reducer/shared.js
function shared_ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function shared_objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){shared_ownKeys(Object(source),true).forEach(function(key){shared_defineProperty(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{shared_ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}function shared_defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true});}else{obj[key]=value;}return obj;}var shared_initialState={};/* harmony default export */ const shared = (function(){var state=arguments.length>0&&arguments[0]!==void 0?arguments[0]:shared_initialState;var action=arguments.length>1?arguments[1]:void 0;switch(action.type){case platformfrom_dll_reference_platform_dll.constants.ADD_SHARED:{var nextState=shared_objectSpread({},state);nextState[action.payload.name]=action.payload.data;return nextState;}case platformfrom_dll_reference_platform_dll.constants.REMOVE_SHARED:{var _nextState=shared_objectSpread({},state);delete _nextState[action.payload.name];return _nextState;}default:{return state;}}});
...
/*!**********************************************************************************************!*\
  !*** delegated ./node_modules/react-router-dom/index.js from dll-reference dependencies_dll ***!
  \**********************************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = (__webpack_require__(/*! dll-reference dependencies_dll */ "dll-reference dependencies_dll"))("./node_modules/react-router-dom/index.js");
