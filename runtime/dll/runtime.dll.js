...
var initialState={language:"en-US",messages:{},entrypoint:null,ready:false};/* harmony default export */ const runtime = (function(){var state=arguments.length>0&&arguments[0]!==void 0?arguments[0]:initialState;var action=arguments.length>1?arguments[1]:void 0;switch(action.type){case platformfrom_dll_reference_platform_dll.constants.SET_LANGUAGE:{return{language:action.payload.language,entrypoint:state.entrypoint,ready:state.ready};}case platformfrom_dll_reference_platform_dll.constants.ADD_I18N_MESSAGES:{console.debug('runtime add i18n messages',action.payload);return state;}case platformfrom_dll_reference_platform_dll.constants.REMOVE_I18N_MESSAGES:{console.debug('runtime remove i18n messages',action.payload);return state;}case platformfrom_dll_reference_platform_dll.constants.MODULES_READY:{return{language:state.language,entrypoint:state.entrypoint,ready:action.payload.isReady};}case platformfrom_dll_reference_platform_dll.constants.SET_ENTRYPOINT_MODULE:{return{language:state.language,entrypoint:action.payload.entrypoint,ready:state.ready};}default:{return state;}}});
