...
/* harmony default export */ const runtime = (function () {
  var state = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : initialState;
  var action = arguments.length > 1 ? arguments[1] : void 0;

  switch (action.type) {
    case platformfrom_dll_reference_platform_dll.constants.MODULES_READY:
      {
        return {
    ...
    case platformfrom_dll_reference_platform_dll.constants.SET_ENTRYPOINT_MODULE:
      {
        return {
...
var shared_initialState = {};
/* harmony default export */ const shared = (function () {
  var state = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : shared_initialState;
  var action = arguments.length > 1 ? arguments[1] : void 0;

  switch (action.type) {
    case platformfrom_dll_reference_platform_dll.constants.ADD_SHARED:
      {
    ...
    case platformfrom_dll_reference_platform_dll.constants.REMOVE_SHARED:
      {
        var _nextState = _objectSpread({}, state);

        delete _nextState[action.payload.name];
        return _nextState;
      }
...
var _marked = /*#__PURE__*/regeneratorfrom_dll_reference_dependencies_dll_default().mark(watchInit),
  ...
  return regeneratorfrom_dll_reference_dependencies_dll_default().wrap(function watchInit$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0,redux_saga_effects_npm_proxy_cjsfrom_dll_reference_dependencies_dll.takeLatest)(platformfrom_dll_reference_platform_dll.constants.INIT, runInit);
...
function runInit(action) {
  var context;
  return regeneratorfrom_dll_reference_dependencies_dll_default().wrap(function runInit$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          _context2.next = 5;
          return (0,redux_saga_effects_npm_proxy_cjsfrom_dll_reference_dependencies_dll.put)(platformfrom_dll_reference_platform_dll.actions.setAvailableModules(context.available));

        case 5:
          _context2.next = 7;
          return (0,redux_saga_effects_npm_proxy_cjsfrom_dll_reference_dependencies_dll.put)(platformfrom_dll_reference_platform_dll.actions.setEntryPointModule(context.entrypoint));
...
/* harmony default export */ const saga = ([watchInit]);
...
/* harmony default export */ const runtime_store = (/*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorfrom_dll_reference_dependencies_dll_default().mark(function _callee() {
  var loader, sagaMiddleware, enhancers, composer, reducer, store;
  return regeneratorfrom_dll_reference_dependencies_dll_default().wrap(function _callee$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          loader = (0,platformfrom_dll_reference_platform_dll.createModuleLoader)();
          sagaMiddleware = redux_saga_core_npm_proxy_cjsfrom_dll_reference_dependencies_dll_default()();
          enhancers = [sagaMiddleware, (0,libfrom_dll_reference_dependencies_dll.routerMiddleware)(platformfrom_dll_reference_platform_dll.history), (0,platformfrom_dll_reference_platform_dll.moduleLoaderMiddleware)(loader)];

          if (window.__GROOPIE_EXTENSION__) {
            enhancers.unshift(window.__GROOPIE_EXTENSION__);
          }

          composer = reduxfrom_dll_reference_dependencies_dll.compose; //window.__GROOPIE_EXTENSION__ || compose

          reducer = (0,reduxfrom_dll_reference_dependencies_dll.combineReducers)({
            runtime: runtimeReducer,
            shared: sharedReducer,
            router: (0,libfrom_dll_reference_dependencies_dll.connectRouter)(platformfrom_dll_reference_platform_dll.history),
            modules: loader.getReducer()
          });
          store = (0,reduxfrom_dll_reference_dependencies_dll.createStore)(reducer, {}, composer.apply(void 0, [reduxfrom_dll_reference_dependencies_dll.applyMiddleware.apply(void 0, enhancers)]));
          loader.setSagaRunner(sagaMiddleware.run);
          loader.setStore(store);
          sagaMiddleware.run( /*#__PURE__*/regeneratorfrom_dll_reference_dependencies_dll_default().mark(function rooSaga() {
            return regeneratorfrom_dll_reference_dependencies_dll_default().wrap(function rooSaga$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return (0,redux_saga_effects_npm_proxy_cjsfrom_dll_reference_dependencies_dll.all)(saga.map(redux_saga_effects_npm_proxy_cjsfrom_dll_reference_dependencies_dll.fork));
          ...
          return _context2.abrupt("return", [store, loader]);
...
var ReduxProvider = function ReduxProvider(props) {
  var _React$useState = reactfrom_dll_reference_dependencies_dll.useState(),
      _React$useState2 = _slicedToArray(_React$useState, 2),
      _ = _React$useState2[0],
      setErrorState = _React$useState2[1];

  var _React$useState3 = reactfrom_dll_reference_dependencies_dll.useState({
    store: void 0,
    moduleLoader: void 0,
    isReady: false
  }),
  ...
  var setupProviders = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorfrom_dll_reference_dependencies_dll_default().mark(function _callee() {
      var _yield$setupStore, _yield$setupStore2, store, moduleLoader;
      ...
      return regeneratorfrom_dll_reference_dependencies_dll_default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              _yield$setupStore = _context.sent;
              _yield$setupStore2 = _slicedToArray(_yield$setupStore, 2);
              store = _yield$setupStore2[0];
              moduleLoader = _yield$setupStore2[1];
              setState({
                store: store,
    ...
    return function setupProviders() {
      return _ref.apply(this, arguments);
    };
  }();

  reactfrom_dll_reference_dependencies_dll.useEffect(function () {
    setupProviders();
  }, []);
  ...
  return /*#__PURE__*/reactfrom_dll_reference_dependencies_dll.createElement(platformfrom_dll_reference_platform_dll.ModuleContext.Provider, {
    value: state.moduleLoader
  }, /*#__PURE__*/reactfrom_dll_reference_dependencies_dll.createElement(react_redux_libfrom_dll_reference_dependencies_dll.Provider, {
    store: state.store
  }, props.children));
};

/* harmony default export */ const component_ReduxProvider = (ReduxProvider);
;// CONCATENATED MODULE: ./node_modules/@lastui/rocker/runtime/selector/index.js
var getEntrypoint = function getEntrypoint(state) {
  return state.runtime.entrypoint;
};
...
/* harmony default export */ const component_Entrypoint = (Entrypoint);
...
/* harmony default export */ const rocker_runtime = ({
  Main: component_Main
});
